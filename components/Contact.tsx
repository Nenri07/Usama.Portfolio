 ...
 *
 * Server component: the disabled state is computed once at render from the
 * static `contact` data — no client state is needed — so page.tsx stays a
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col items-center text-center">
        ...
        */}
        <div className="mt-12 flex flex-row flex-wrap items-center justify-center gap-6">
          {/* Email button (Req 6.3, 6.4) — maroon accent. */}
          {emailDisabled ? (
            <button
              type="button"
              disabled
          ...
          {/* WhatsApp button (Req 6.5, 6.6) — external link, subtle surface. */}
          {phoneDisabled ? (
            <button
              type="button"
              disabled
